...
async function main() {
  console.log("🚀 Full deployment on Sepolia\n");
  ...
  // 3. Deploy Router (with updated contract)
  console.log("\n3. Deploying Router...");
  ...
  fs.writeFileSync("deployment-new.json", JSON.stringify(config, null, 2));
  ...
  console.log("\n✅ Deployment complete!");
  console.log("\n📋 NEW ADDRESSES (update your frontend):");
  console.log("   ROUTER:", routerAddr);
  console.log("   TKA:", tkaAddr);
  console.log("   TKB:", tkbAddr);
  console.log("   POOL:", poolAddr);
