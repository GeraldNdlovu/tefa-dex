...
async function main() {
  ...
  console.log("\nSending 0.5 Sepolia ETH to relayer...");
  ...
  const relayerBalance = await ethers.provider.getBalance(relayerAddr);
  console.log("Relayer balance now:", ethers.formatEther(relayerBalance));
}
